...
export type SimpleJSONRPCMethod<ServerParams = void> = (params: JSONRPCParams, serverParams: {req: any; res: any; next: Function}) => any;
export type JSONRPCMethod<ServerParams = void> = (request: JSONRPCRequest, serverParams: {req: any; res: any; next: Function}) => JSONRPCResponsePromise;
...
export declare class JSONRPCServer<ServerParams = void> {
    ...
    receive(request: JSONRPCRequest, serverParams?: {req: any; res: any; next: Function}): PromiseLike<JSONRPCResponse | null>;
